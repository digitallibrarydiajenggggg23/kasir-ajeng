...
penjualan ON pelanggan.PelangganID=penjualan.PelangganID");
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo isset($d['NomorTelepon']) ? $d['NomorTelepon'] : '-'; ?></td>
                                ...
                                <form action="proses_update_pembelian.php" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label>No. Telepon</label>
                                           <input type="text" name="NomorTelepon" value="<?php echo isset($d['NomorTelepon']) ? $d['NomorTelepon'] : ''; ?>" class="form-control">
                                          </div>
                                        <div class="form-group">
                                            <label>Alamat</label>
